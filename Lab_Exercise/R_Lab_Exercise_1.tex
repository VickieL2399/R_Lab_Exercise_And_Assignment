...
\NormalTok{v\_letters }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(letters)}
\NormalTok{v\_letters}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m\_letters }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{c}\NormalTok{(LETTERS),}
                    \AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }
                    \AttributeTok{byrow =}\NormalTok{ T)}
\NormalTok{m\_letters}
\end{Highlighting}
\end{Shaded}
